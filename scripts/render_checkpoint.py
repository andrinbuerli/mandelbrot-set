...
parser.add_argument('--iterations', nargs='+', default=[10], help='List of iterations')
parser.add_argument('--zoomed', action='store_true', help='Zoomed in image')
args = parser.parse_args()

nn = MandelbrotNN(num_hidden_layers=6, hidden_dim=2048)
...
for iter in tqdm(args.iterations):
    ...
    fig.tight_layout()
    fig.savefig(f"mandelbrot_{iter}.png", dpi=300)